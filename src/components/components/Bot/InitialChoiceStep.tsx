            ...
            <div className="rounded-xl p-6 max-w-2xl mx-auto bg-transparent">
                ...
                {showPrompt && (
                    <>
                        ...
                        <div id="chat-mode-options" className="flex flex-col sm:flex-row justify-center gap-4">
                            <ButtonChoiceBot
                                options={[
                                    { label: "Fazer quiz (5 perguntas)", value: "quiz", id: "quiz-button" },
                                    { label: "Conversar sobre lógica de programação", value: "chat", variant: "green", id: "chat-button" },
                                ]}
