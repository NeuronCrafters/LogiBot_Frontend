...
const ChatLayout: React.FC<ChatLayoutProps> = ({ user, children }) => {
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <div className="flex min-h-screen bg-[#141414] flex-col items-center w-full">
      {/* Header - Compartilhado por todas as versões */}
      ...
      {/* Conteúdo principal - Será diferente dependendo do tipo de usuário */}
      {children}
    </div>
  );
};
